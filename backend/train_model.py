...
# Auto-restart in .venv if not already active
if ".venv" not in sys.prefix:
    ...
    if os.path.exists(venv_python):
        print(f"🔄 Auto-switching to virtual environment python: {venv_python}", file=sys.stderr)
        import subprocess
...
# -----------------------------
# Metrics at tuned/optimal threshold
# -----------------------------
...
model_path = os.path.join(root_dir, "credit_model.pkl")
