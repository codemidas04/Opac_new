...
# ========================================
models = joblib.load(os.path.join(os.path.dirname(os.path.dirname(__file__)), "results", "fold_models.pkl"))
...
# Save CSV
csv_path = os.path.join(os.path.dirname(os.path.dirname(__file__)), "results", "shap_mean_abs_importance.csv")
...
plt.tight_layout()
plot_path = os.path.join(os.path.dirname(os.path.dirname(__file__)), "results", "shap_importance_plot.png")
plt.savefig(plot_path, dpi=300)
print(f"\n📊 Saved SHAP importance plot to {plot_path}")
plt.show()
...
beeswarm_path = os.path.join(os.path.dirname(os.path.dirname(__file__)), "results", "shap_beeswarm.png")
...
perm_path = os.path.join(os.path.dirname(os.path.dirname(__file__)), "results", "permutation_importance.csv")
...
out_dir = os.path.join(os.path.dirname(os.path.dirname(__file__)), "results", "shap_dependence")
...
with PdfPages(pdf_path) as pdf:
    ...
    plt.title(f"Top {top_n} Features by SHAP Importance (5-fold avg)")
    plt.tight_layout()
    plt.savefig(os.path.join(out_dir, "..", "shap_importance_plot.png"), dpi=300)
    ...
    plt.tight_layout()
    plt.savefig(os.path.join(out_dir, "..", "permutation_importance_plot.png"), dpi=300)
    pdf.savefig(plt.gcf(), dpi=300, bbox_inches="tight")
    plt.close()
...
perm_path2 = os.path.join(os.path.dirname(os.path.dirname(__file__)), "results", "permutation_importance.csv")
perm_df.to_csv(perm_path2, index=False)
print(f"✅ Saved permutation importance to {perm_path2}")
print("\nTop 10 permutation importance features:")
print(perm_df.head(10).to_string(index=False))
